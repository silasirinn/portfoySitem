...
export function Hero() {
  ...
  return (
    ...
    >
      {/* Animated Background Elements - sadece tablet/desktop */}
      {!isMobile && (
        ...
        <div className="text-center">
          ...
          >
            <motion.h1
              ...
              initial={{ opacity: 0, scale: isMobile ? 0.9 : 0.5 }}
          ...
          >
            Flutter ve iOS mobil geliştirme, web teknolojileri ve yapay zeka
            alanlarında kendimi geliştiren bir yazılım mühendisliği öğrencisiyim.
          </motion.p>
      ...
      {/* Scroll Indicator – mobilde daha hafif ama duruyor */}
      <motion.div
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2"
        animate={isMobile ? { y: [0, 6, 0] } : { y: [0, 10, 0] }}
      ...
      >
        <div className="w-6 h-10 border-2 border-purple-600 rounded-full flex justify-center">
          <motion.div
            ...
            animate={isMobile ? { y: [0, 12, 0] } : { y: [0, 20, 0] }}
            transition={{ duration: 1.5, repeat: Infinity }}
          />
        </div>
      </motion.div>
